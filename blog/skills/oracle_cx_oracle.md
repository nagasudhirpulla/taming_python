...
-   Before executing the insert command, we have executed a delete command and deleted existing rows to avoid conflicts while insertion. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzMTYyOTcxNSwxODI2MTQyMzc3LC0zND
