...
- We injected input variables to SQL text using placeholders (like `:1`, `:2` etc) to avoid the risk of SQL injection.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MzE2NjI1NDcsMTM3NjkwNDY2NywxOD
