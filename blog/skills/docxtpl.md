...
If can render a variable named ```xyz``` by writing ```{{ xyz }}``` in the template word file. The variable can be an image or  text
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTUwMTE5NDAsMTcyMDE0NjY3MCw3NT
