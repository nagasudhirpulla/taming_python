...
* Go to the database plugins folder and copy all the jar files corresponding to the required database driver and paste in the PC without internet
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyMjQ2NDg5NCwxMTg5Njc3MTc1LC00Nz
