...
```
* In the above example, the URL to the flask route function `getItem` within the same blueprint can be generated using `url_for('.getItem')`
* The 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NjE5MDEyMzMsLTg3Nzg5NjQxNCwtMT
