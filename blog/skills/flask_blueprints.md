...
```
* In the above example, the URL to the python route function `getItem` within the same blueprint can be generated using `url_for('.getItem')`
* The 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4ODM1MTQzNCwtODc3ODk2NDE0LC0xMT
