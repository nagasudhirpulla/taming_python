...
* One downside of using `nlst` is that the information whether the filename is file or folder is not known. This needs to be determined separately. IN 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYxNTg5MDU5NywxODU2NzIwMTQ4LDEyNj
