...
* However the string returned by the `dir` command is dependent in the FTP server technology. For example, `dir` comman
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYyOTQ3MDg4MSwxODU2NzIwMTQ4LDEyNj
