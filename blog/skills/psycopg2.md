...
* The ```conn.commit()``` function is committing all the uncommitted changes made to the database by the SQL commands executed by the cursor. Without calling this function, the database changes made by the cursor object will not be permanent.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgxMzM5ODQ3OCwxODYwNzE2MjY1LDY5OD
