...
* Using ```[row[0] for row in cur.description]``` will return the column names in order for the fetched data tuples. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE1ODgwOTQ2LDQwODE4MDc3LDE0NDg0Nj
