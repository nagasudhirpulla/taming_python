...
```
* We can use helper functions to make the file size (in bytes) and modified time (POSIX timestamp) more readable
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzc5MzI1NDA4LC0xOTMxNjEzMDg4LC0xMj
U3NDE2ODQ5XX0=
-->