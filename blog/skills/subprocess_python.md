...
* In the above python code a function named  `computeFromExternal` runs a dotnet project program in the folder `compute/` relative to the python code
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTczMjUyNzEwOCwyMTQ5MDM1NTcsNzgwMz
