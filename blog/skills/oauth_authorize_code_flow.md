...
- As a one time activity, the client application will be registered in the OAuth server. The client will be given “client id” and “client secret” by the STS
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUzNTMyOTExNCwxODUwMDczOTMyLC0xOT
c2MDI2NTQ5XX0=
-->