...
* Web applications can choose not store users information in a database or implement login, account management, user aman screens
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQwNDg3MjA2LC0xOTc2MDI2NTQ5XX0=
-->