...
* In this flask server, flask session is used for managing the user session. Other approaches for managing user sessions like using ***flask-login***
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4MTU1NDQwNywtMTU0Njk5MDAyOCw1OD
