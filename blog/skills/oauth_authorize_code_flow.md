...
* Since the users information is centrally stored in the OAuth server, multiple web applications can make users login with same credentials in a single login screen, thus facilitating Single-Sign-On (SSO) possible
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1OTI0OTYyMiwtMTk3NjAyNjU0OV19
-->