...
* Also it facilitates observability of the database sessions, I/O, transactions, statistics etc via a dashboard screen
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MTg4Njg1MzYsLTkxNTEyMTAxMiwxMz
