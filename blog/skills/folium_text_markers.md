...
* HTML content can be used as the DivIcon. So we can write the desired text in the DivIcon, to achieve the text-marker effect
* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4NDM3NjEyOCwxMzUxOTE2NzMzLDEyOD
YyOTY1MDBdfQ==
-->