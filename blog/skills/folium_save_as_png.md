...
* Gecko driver - This is used by selenium library to open firefox browser. Download the executable from (here)[https://github.com/mozilla/geckodriver/releases] and keep the exe file in the same location as the python file. Alternatively, you can place the exe file at some folder location and add that folder location to the **PATH** variable of the system.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwOTYwNTUwOCw4ODUwNDczNDhdfQ==
-->