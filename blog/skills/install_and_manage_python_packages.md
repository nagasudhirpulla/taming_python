...
* Then create a key value pair `"python.pythonPath" : "path\\to\\env_folder\\Scripts\\python.exe"` in *settings.json* file as shown below.
...
9uX3NraWxsXG4iLCJoaXN0b3J5IjpbLTE3ODcyNjQxODAsLTM4
