...
```
* Open a command inside the 'static' folder and run the command `npm install`. Then all the required libararies will be downloaded into the `static/node_modules` folder. Using npm requires NodeJS installed with an internet connection
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzE1MzM4OTIsMTQ4NzY5MjU2NSwtND
