...
* For example, inside the `head` block of the `home.html.j2` file, an additional script tag is added below `{{ super() }}`. Hence the parent 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3MzcyNTc2OSwtNDQyNjIzMzksMTgyNz
