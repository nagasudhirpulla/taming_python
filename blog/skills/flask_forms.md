...
* Once the user clicks the submit button, a "POST" request is sent to the same page where the form inputs can be processed by the server route handler
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk3NjQ3Njc3MiwxOTI2ODEwNTk0LDIwMT
