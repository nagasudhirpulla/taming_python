...
## Use case
* A syslog server written in python can be used to just store logs or create data pipelines or automation upon receiving syslog messages over the network
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0MDg5ODQwNCwtMTM1NzM0ODgwM119
-->