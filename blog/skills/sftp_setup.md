...
* Set protocol as SFTP, port as 21, hostname as localhost, enter username and password. Finally click login
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMTU3NzYwMTksLTEwMDQwNTIwNTcsLT
