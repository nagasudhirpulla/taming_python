...
* During the key generation process, password protection can be set to private key by entering a passphrase as shown in the above image. This adds additional protection to the private key in case the private key is in the wrong hands
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE1MDUwOTE2LC03MjQ0Mzg5ODksLTE4Nj
