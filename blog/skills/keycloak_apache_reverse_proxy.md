...
*  `ProxyAddHeaders On` will add additional headers (X-Forwarded-For, X-Forwarded-Host and X-Forwarded-Server) to the request and pass them to Keycloak 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTcyOTc1Njk0LC00NjQ1OTQ2MTksMTA5MD
