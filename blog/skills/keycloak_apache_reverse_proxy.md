...
* In Reencypt mode, clients connect to Reverse Proxy via HTTPS and reverse proxy also connects to Keycloak via HTTPS. Hence SSL certificates are needed to be configured in both Reverse Proxy and   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzMzUzNTA2MCwxMDkwODI0NzYzLC0xMz
