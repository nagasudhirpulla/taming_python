...
* A flask decorator that acts as a request middleware will be used to add authorization to the flask server endpoint
* The workflow
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE4OTMwNjMsLTEwNzAwNTA4OTEsMTc4ND
E3NjM4NF19
-->