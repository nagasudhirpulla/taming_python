...
* all the styling options can be found at https://leafletjs.com/reference-1.6.0.html#path . Use snake case in python instead of camelCase for spec
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTg1MjY5NjEsMTY2OTkxODU2OF19
-->