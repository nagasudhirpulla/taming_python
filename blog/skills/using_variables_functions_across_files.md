...
* As shown in the above figure, the code of our example python application will be distributed in the folders as shown in the above image
* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTU0NTUyNDc5LDEwMTQ4NDE5NDddfQ==
-->