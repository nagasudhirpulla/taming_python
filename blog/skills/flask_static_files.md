...
* In the below example, the 'report' function listening at the URL '/report' will serve the file 'xyz.pdf' using `send`
```py
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwMTk4NDE5LDIwNjM2NDE2MTYsMTg0NT
