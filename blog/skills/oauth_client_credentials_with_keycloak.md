...
* For example, as per the JWT received in the above example, the signature of the `<header>.<payload>` part of JWT can be signed and the
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYxNDk1MTMxMiwtMTI4NTU4NTE3MSwtMT
