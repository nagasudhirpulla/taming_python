...
```
* The access token fetched from the token endpoint by the client application can be attached in the requests being made to resource server. The resource server will validate the access token present in the request for authorizing the request from client application.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODcxMjk5MTg2LDc2MTQ5MTg1OSwxMzMzND
I1MTAzLC0xMzk1MTc3OTg5LDE4MDg1NTQ3NDMsMTczNjcwNDU4
LDExNzg5ODcyOTIsLTEyNDYwMjg2ODldfQ==
-->